	...
	Если ТипФайлаПоддерживается(АнализируемыйФайл) Тогда
		...
		Если СтрСравнить(АнализируемыйФайл.Расширение, ".cfe") <> 0 Тогда
			...
			СконвертироватьВПроектЕДТ(КаталогВыгрузки,
				"E:\1C\21vek\выгрузка обработок\temp\workspace",
				"E:\1C\21vek\выгрузка обработок\temp\project");
			
			УдалитьФайлы("E:\1C\21vek\выгрузка обработок\temp\workspace");
			
			СписокФайловПослеКонвертации = НайтиФайлы("E:\1C\21vek\выгрузка обработок\temp\project", ".", Истина);
			
			Для каждого ФайлПослеКонв Из СписокФайловПослеКонвертации Цикл
				
				
				
				ЧастичныйПуть = СтрЗаменить(ФайлПослеКонв.ПолноеИмя, "E:\1C\21vek\выгрузка обработок\temp\project\", "");
			...
			УдалитьФайлы("E:\1C\21vek\выгрузка обработок\temp\project");
