...
Процедура ЗапускПриложения()
	...
	КаталогРепозитория = "E:\1C\21vek\выгрузка обработок\репозиторий";
	
	ТекущийКаталогИсходныхФайлов = "E:\1C\21vek\выгрузка обработок\temp";//ОбъединитьПути(КаталогРепозитория, "src");
